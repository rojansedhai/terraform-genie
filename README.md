...
Get Your Credentials: After deployment, Terraform will output your API URL and your Secret Key.
...
Run the provided test script: Update the API_URL variable in test_genie.py with your endpoint from the deployment step, then run:
